        ...
        <div style={{
            ...
            <div style={{ width: '100%', maxWidth: '420px', textAlign: 'center', position: 'relative', zIndex: 10 }}>
                ...
                >
                    ...
                    <h1 style={{ fontSize: '34px', fontWeight: '900', marginBottom: '8px', letterSpacing: '-1px' }}>
                        {isRegister ? (regStep === 1 ? 'Bienvenue !' : 'Sécurité') : 'Bon retour !'}
                    </h1>
                    <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: '15px', fontWeight: '500' }}>
                        {isRegister 
                            ? (regStep === 1 ? 'Commençons par ton email' : 'Choisis un mot de passe robuste') 
                            : 'Prépare ton prochain repas équilibré'}
                    </p>
                </motion.div>
                            ...
                            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
                                ...
                                <motion.button
                                    ...
                                    style={{
                                        ...
                                        marginTop: '8px',
                                        boxShadow: isLoading ? 'none' : '0 12px 24px rgba(16,185,129,0.2)',
                                ...
                                >
                                    {isLoading ? (
                                        ...
                                        <>
                                            {isRegister ? (regStep === 1 ? 'Suivant' : 'Créer mon compte') : 'Se connecter'}
