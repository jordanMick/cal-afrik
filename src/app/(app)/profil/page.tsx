                    ...
                    <div style={{ position: 'fixed', inset: 0, zIndex: 3000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
                        ...
                        >
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                                <button
                                    onClick={() => { window.open('https://wa.me/22891625879?text=Bonjour%20Coach%20Yao,%20j\'ai%20besoin%20d\'aide%20sur%20l\'application%20Cal-Afrik', '_blank'); setShowSupportModal(false) }}
