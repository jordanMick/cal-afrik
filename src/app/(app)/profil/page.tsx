    ...
    return (
        <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                ...
                <div>
                    <p style={{ color: 'var(--text-muted)', fontSize: '10px', textTransform: 'uppercase', fontWeight: '700', letterSpacing: '0.05em' }}>Code Promo</p>
                    <p style={{ color: 'var(--text-primary)', fontSize: '15px', fontWeight: '800', letterSpacing: '1px' }}>{code}</p>
                </div>
            </div>
            <button
                onClick={handleCopy}
    ...
    return (
        <div style={{ minHeight: '100vh', background: 'var(--bg-primary)', fontFamily: 'system-ui, sans-serif', maxWidth: '480px', margin: '0 auto', paddingBottom: '100px', position: 'relative', overflow: 'hidden', color: 'var(--text-primary)' }}>
            ...
            <div style={{ padding: '0 20px' }}>
                ...
                {/* CODE PROMO (Placé avant WhatsApp pour un meilleur flux) */}
                {profile?.promo_code && (
                ...
                <div style={{ background: 'var(--bg-secondary)', border: '0.5px solid var(--border-color)', borderRadius: '16px', overflow: 'hidden', marginTop: '32px', marginBottom: '24px' }}>
                    ...
                    >
                        <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
                            ...
                            <span style={{ color: 'var(--text-primary)', fontSize: '15px', fontWeight: '500' }}>Support</span>
                        </div>
                        <ChevronRight size={18} color="var(--text-muted)" strokeWidth={2} />
                    </button>
