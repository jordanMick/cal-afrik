    ...
    return (
        <div style={{ minHeight: '100vh', background: '#0a0a0a', fontFamily: 'system-ui, sans-serif', maxWidth: '480px', margin: '0 auto', paddingBottom: '40px' }}>
            ...
            <div style={{ padding: '52px 20px 20px', display: 'flex', alignItems: 'center', gap: '16px' }}>
                ...
                <h1 style={{ color: '#fff', fontSize: '20px', fontWeight: '800' }}>Infos personnelles</h1>
            </div>
            ...
            <div style={{ padding: '0 20px', marginTop: '10px' }}>
                    ...
                    {[
                        ...
                        <div key={item.label} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '16px', borderBottom: i < arr.length - 1 ? '0.5px solid #1a1a1a' : 'none' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                                ...
                                <span style={{ color: '#aaa', fontSize: '14px' }}>{item.label}</span>
                            </div>
                ...
                <button
                    ...
                    style={{ width: '100%', padding: '16px', background: 'rgba(255,255,255,0.05)', border: '1px solid #333', borderRadius: '16px', color: '#fff', fontWeight: '700', fontSize: '15px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', cursor: 'pointer' }}
                >
                    <Pencil size={18} />
